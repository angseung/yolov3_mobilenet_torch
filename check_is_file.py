...
for fname in validation_list:
    ...
    shutil.copy(f"./data/yperv1/images/train/{fname}.jpg", f"./data/yperv1/images/val/{fname}.jpg")
    shutil.copy(f"./data/yperv1/labels/train/{fname}.txt", f"./data/yperv1/labels/val/{fname}.txt")
